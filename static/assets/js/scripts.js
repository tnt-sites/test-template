$(function () {
    ...
    if ($(window).width() <= 1090) {
        ...
        $("#banner .links").insertAfter("#banner article .content");
...
$(function () {
    ...
    $(".slick-reviews").slick({
        ...
        prevArrow: '<button class="arrow" id="prev" aria-label="Previous Slide"><img src="assets/images/arrow-left.svg" alt=""></button>',

        nextArrow: '<button class="arrow" id="next" aria-label="Next Slide"><img src="assets/images/arrow-left.svg" alt=""></button>',
    ...
    if (theWindow.width() <= 1000) {
        ...
        $('#reviews .slick-controls').insertAfter('.slick-reviews');
...
const playIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="78" height="90" viewBox="0 0 78 90"> <g id="Pol?gono_1" data-name="Pol?gono 1" transform="translate(78) rotate(90)" fill="none"> <path d="M45,0,90,78H0Z" stroke="none"/> <path d="M 45 2.001113891601562 L 1.731414794921875 77 L 88.26858520507812 77 L 45 2.001113891601562 M 45 0 L 90 78 L 0 78 L 45 0 Z" stroke="none" fill="#fff"/> </g> </svg>';

$('.play-icon').html(playIcon);
