    ...
    try {
      ...
      const anchorIds = await page.evaluate(() => {
        ...
        for (const a of document.querySelectorAll('a[href*="#"]')) {
          ...
          if (!target) continue;
          // A disclosure toggle is not a section boundary. Bootstrap-based
          // builders (Avada among them) point each accordion header at its own
          // panel with `href="#collapse-…"`, and every one of those looks like
          // an in-page anchor. Splitting a section there cuts the accordion into
