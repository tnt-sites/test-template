...
If one or more teeth are missing simultaneously, the dentist will recommend getting a _dental bridge_. If a missing tooth space is neglected, existing teeth are more prone to shifting into that space. As a result, the teeth will be misaligned. In addition, the imbalance caused by a lost tooth can lead to gum disease and a temporomandibular joint problem.
