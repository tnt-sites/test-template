...
A dental implant is a titanium post that fuses to the jawbone through a process called osseointegration. Once fused, this post provides enduring support for the crown. The finished result is a prosthetic that looks, feels, and acts just like a natural tooth. With proper care and oral hygiene, _dental implants_ can be permanent.
