...
_mig:
  ...
  gen: wpmig
  hash: ""
title: Dental Crowns Middletown
description: ""
canonical: /porcelain-crowns-caps/
pageSections:
  - _component: page-sections/wpmig/page-hero-digital
    id: ""
    heading: Dental Crowns Middletown
    ...
    blocks:
      - type: text
        text: |-
          ...
          <p>Although there are several types of crowns, porcelain (tooth colored crown) are the most popular, because they resemble your natural teeth. They are highly durable and will last many years, but like most dental restorations, they may eventually need to be replaced. Porcelain crowns in Middletown are made to match the shape, size, and color or your teeth giving you a natural, long-lasting beautiful smile.</p>
      - type: image
        image: /wp-content/uploads/2025/05/Porcelain-Crowns-Caps-1024x275.jpg
        imageAlt: Senior couple with dental crowns in Middletown smiling and hugging at fair
      - type: heading
        level: h3
        text: "Reasons for crowns:"
      - type: list
        items:
          - text: Broken or fractured teeth.
          - text: Cosmetic enhancement.
          - text: Decayed teeth.
          - text: Fractured fillings.
          - text: Large fillings.
          - text: Tooth has a root canal.
      - type: heading
        level: h3
        text: What does getting a crown involve?
      - type: text
        text: |-
