...
- _component: page-sections/heroes/page-banner
  ...
  location: ''
  intro:
  - From single tooth replacements to an entire arch of teeth, North County Cosmetic and Implant Dentistry
    is here to help with cutting edge technology and customized treatment plans so you can enjoy your
    favorite foods, improve your health, and love life again.
...
- _component: page-sections/builders/content-with-sidebar
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/text
      text: When you’re dealing with missing or broken teeth, it’s easy to get frustrated. Maybe other
        doctors have told you your case is too complicated. Maybe you’ve been embarrassed about your smile.
        Maybe your health has suffered. Maybe you’ve even had to give up parts of your life like spending
        time with family or visiting friends. Whatever your situation, we can help. Not only do dental
        implants improve the look of your smile, they’re also permanent, promote healthy jawbone growth,
        and can help reduce your risk for systemic disease.
    - _component: building-blocks/core-elements/heading
    ...
    - _component: building-blocks/core-elements/text
      text: Armed with extensive experience gained in hospitals, the military, and specialized training--even
        ...
        dentists have turned you down, chances are we can help you! We’re committed to getting to know
        you, your situation, and your challenges so that we can help you become healthier, happier, and
        have the confidence to go out and enjoy life again.
    maxContentWidth: xl
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/embed
      html: <iframe src="https://www.youtube.com/embed/mG7rSnJYF3A" title="YouTube video player" frameborder="0"
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/heading
      ...
      size: md
    - _component: building-blocks/core-elements/text
      text: There are a variety of implant solutions. We’ll help you navigate your choices and choose
        the right implant for your unique needs.
    ...
    - _component: building-blocks/core-elements/heading
      ...
      size: sm
    - _component: building-blocks/core-elements/text
      text: Using a titanium “root” and a porcelain crown, we can help you fill in the gap created by
        a single missing tooth, and love your smile again.
    - _component: building-blocks/core-elements/image
    ...
    - _component: building-blocks/core-elements/heading
      ...
      size: sm
    - _component: building-blocks/core-elements/text
      text: Get a full set of teeth without having to undergo multiple surgeries. Even better, we can
        typically complete it in our office in one appointment!
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: xl
    colorScheme: default
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/heading
      ...
      size: sm
    - _component: building-blocks/core-elements/text
      text: The easiest way to avoid infection and dental implant failure is to keep your mouth clean.
        This means cleaning your smile thoroughly after each meal, beginning the day after your procedure.
        At North County Cosmetic and Implant Dentistry, we recommend using a soft-bristled toothbrush
        and toothpaste that contains non-abrasive ingredients to ensure that you don’t damage the implant
        or irritate the structures that support it.
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: xl
    colorScheme: default
