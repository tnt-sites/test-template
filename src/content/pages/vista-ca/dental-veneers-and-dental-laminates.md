...
- _component: page-sections/builders/content-with-sidebar
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/heading
      ...
      size: md
    - _component: building-blocks/core-elements/text
      text: We also use dental veneers for restorations. When teeth become cracked, chipped or broken,
        a veneer can restore the tooth to its full functionality. As long as the tooth structure is intact,
    ...
    - _component: building-blocks/core-elements/heading
      ...
      size: md
    - _component: building-blocks/core-elements/text
      text: When patients visit our North County Cosmetic and Implant Dentistry offices, we will take
        an impression of their teeth to create the veneers in a lab. The veneers will match the size,
        shape, and color of your teeth, taking a week or more to create.
    - _component: building-blocks/core-elements/text
    ...
    - _component: building-blocks/core-elements/text
      text: Your teeth will typically be sore for a few days after the preparation phase and after placing
        ...
        Patients can also benefit from getting rest and using a cold compress to reduce any swelling.
        We recommend that patients watch what they eat for a few days and stick with foods that are soft.
        While there is a short recovery time when getting veneers, the procedure is entirely worth it
        because in the end, you will have a beautiful smile.
    - _component: building-blocks/core-elements/heading
      text: Benefits of Dental Veneers
      level: h3
      size: md
    - _component: building-blocks/core-elements/text
      text: One main benefit of veneers that patients enjoy is how the veneers make their teeth look.
        This procedure is an excellent solution, since the veneers can transform your smile into one that
        looks perfect and beautiful. The veneer uses your natural teeth, so there is no need for surgery,
        and the recovery time is reduced. Since the veneers are made to match your other teeth, they will
        look natural, and no one will be able to tell that you had any cosmetic dentistry work completed.
        Another benefit is that they are made out of a stain resistant material. This means that your
        teeth will stay whiter and brighter, even if your favorite beverage is a hot cup of coffee. We
        can use dental veneers to transform your smile.
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: xl
    colorScheme: default
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/text
      text: As with most cosmetic procedures, there can be some discomfort associated with getting dental
        ...
        or your teeth are being prepared. The process can take several weeks so there will be a period
        where you need to be careful about what you eat and what activities you engage in. In other words,
        do not play football after getting temporary veneers placed onto your teeth. You should schedule
        the procedure for a time where you will be close to home and able to take easy.
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: xl
    colorScheme: default
