...
- _component: page-sections/builders/custom-section
  ...
  - _component: building-blocks/core-elements/heading
    ...
    size: xl
  - _component: building-blocks/core-elements/text
    text: Keep in mind that while healthy teeth are less likely to become damaged, they still can be and
  ...
  - _component: building-blocks/core-elements/heading
    ...
    size: md
  - _component: building-blocks/core-elements/text
    text: Primarily, mouth guards are necessary when practicing or playing sports. Most people (especially
  ...
  - _component: building-blocks/core-elements/heading
    ...
    size: md
  - _component: building-blocks/core-elements/text
    text: At North County Cosmetic and Implant Dentistry, we encourage patients to wear a mouth guard
...
- _component: page-sections/builders/custom-section
  ...
  - _component: building-blocks/core-elements/heading
    ...
    size: md
  - _component: building-blocks/core-elements/text
    text: Yes, when you visit our office for mouth guards, we can create one that fits perfectly and is
  ...
  - _component: building-blocks/core-elements/heading
    ...
    size: md
  - _component: building-blocks/core-elements/text
    text: We recommend taking them out and rinsing them immediately after you are done wearing them. You
