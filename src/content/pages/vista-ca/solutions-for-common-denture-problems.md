  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/definition-list
      ...
      - _component: building-blocks/core-elements/definition-list/definition-list-item
        ...
        text: Denture adhesive help the dentures remain in the mouth and prevent them from falling out
          when the wearer laughs, speaks or eats.
      - _component: building-blocks/core-elements/definition-list/definition-list-item
        title: Denture Base
      ...
      - _component: building-blocks/core-elements/definition-list/definition-list-item
        ...
        text: Poor fitting dentures are typically loose dentures that do not fit properly and fall out
          when the individual is eating, speaking or laughing.
      - _component: building-blocks/core-elements/definition-list/definition-list-item
        title: Rebase
      ...
      - _component: building-blocks/core-elements/definition-list/definition-list-item
        title: Xerostomia
        text: Xerostomia is also known as dry mouth, which is a condition where the salivary glands do
          not make enough saliva to keep the mouth moist.
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: xl
    colorScheme: default
