---
_schema: default
title: Complete Health Dentistry Membership Club
seo:
  title: Dental Membership Club | Affordable Preventive Care in Vista, CA
  description:
    Join North County Cosmetic and Implant Dentistry’s Membership Club in Vista, CA for affordable,
...
pageSections:
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      ...
      - _component: building-blocks/core-elements/text
        text:
          Frustrated with your dental insurance or putting off treatment because you have no dental insurance
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      ...
      - _component: building-blocks/core-elements/text
        text:
          Forget about yearly maximums or complicated reimbursement applications. Our in-house membership
          club cuts out the middleman so you can get the care you need without the hassle.
      - _component: building-blocks/core-elements/text
        text:
          Choose easy, affordable monthly or annual payments and get all of the preventative care you
          need, plus discounts on any other treatment.
      - _component: building-blocks/core-elements/text
        text:
          With plans for kids, adults, and for patients with ongoing periodontal care, you can choose
          the option that’s right for you. Even better, if you pay for your membership up front, we’ll wave
          the $169 activation fee!
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: 4xl
    colorScheme: inherit
  ...
  - _component: page-sections/builders/custom-section
    ...
    contentSections:
      ...
      - _component: building-blocks/core-elements/text
        text:
          Your health is important to us--that’s why we don’t want you to put off getting the treatment
          that you need for your mouth (and entire body) to stay healthy. That’s why we created our in-house
          membership club. Because you should be able to get the preventative care that you deserve without
          having to worry about insurance coverage.
      - _component: building-blocks/core-elements/heading
      ...
      - _component: building-blocks/core-elements/list
        ...
        items:
          ...
          - _component: building-blocks/core-elements/list/list-item
            text: Emergency exam
          - _component: building-blocks/core-elements/list/list-item
            text: Discounts on other treatments
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: 4xl
    colorScheme: inherit
