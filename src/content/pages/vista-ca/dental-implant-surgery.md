...
seo:
  title: Dental Implant Surgery Vista, CA | North County Cosmetic and Implant Dentistry | What to Expect
    Procedure, Recovery
...
- _component: page-sections/heroes/page-banner
  ...
  - At North County Cosmetic and Implant Dentistry, we can provide you with dental implant surgery to
    ...
    [[phone]] to schedule a consultation with our Vista dental office.
...
- _component: page-sections/builders/content-with-sidebar
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/text
      text: On the day you visit our California dental office for surgery, you will be given anesthesia
        ...
        from 30 minutes for a single implant to several hours. If you are replacing multiple teeth with
        implants, we will let you know how long the process will take and whether or not it will take
        two appointments.
    - _component: building-blocks/core-elements/heading
      text: Post-Operation Care for Dental Implants
      level: h3
      size: md
    - _component: building-blocks/core-elements/text
      text: Since dental implant surgery is an invasive process, you can expect to have some swelling
        and sensitivity after the fact. While perfectly natural, you must take good care of your mouth
        in order to prevent an infection or unnecessary irritation. We suggest taking ibuprofen to decrease
        swelling and manage discomfort. You can also use an icepack or cold compress for 15 minutes at
        a time. At North County Cosmetic and Implant Dentistry, we generally recommend taking a couple
        of days off work while you are recovering. After two to five days, you will feel normal again;
        though your gums may remain slightly sensitive for a little longer.
    maxContentWidth: xl
    ...
    - _component: building-blocks/core-elements/list
      ...
      - _component: building-blocks/core-elements/list/list-item
        text: Q. A. Yes, at North County Cosmetic and Implant Dentistry, we place implants on a regular
          ...
          a bone graft prior to beginning. To discuss this further, call [[[phone]]]([[phoneHref]])
      ...
      - _component: building-blocks/core-elements/list/list-item
        text: Q. A. Before you can begin, we need to examine you and take X-rays to determine the density
          ...
          our Vista dental office at [[[phone]]]([[phoneHref]]).
    maxContentWidth: xl
    paddingHorizontal: lg
    paddingVertical: xl
    colorScheme: default
  ...
  - _component: page-sections/builders/custom-section
    ...
    - _component: building-blocks/core-elements/list
      ...
      - _component: building-blocks/core-elements/list/list-item
        text: Q. [How long until they attach the tooth to my dental implant?](/vista-ca/dental-implant-surgery/#how-long-until-they-attach-the-tooth)
    - _component: building-blocks/core-elements/heading
