...
title: Periodontics
description: >-
  Specialized care for the gums and supporting structures of your teeth. Chapel Hill Dental Arts, Red Bank, NJ.
  ...
  - _component: page-sections/ctas/services-grid
    ...
    services:
      - _component: page-sections/ctas/services-grid/services-grid-item
        imageSource: ""
        imageAlt: What is a Periodontist?
      ...
      - _component: page-sections/ctas/services-grid/services-grid-item
        imageSource: ""
        imageAlt: When to See a Periodontist
      ...
      - _component: page-sections/ctas/services-grid/services-grid-item
        imageSource: ""
        imageAlt: Pocket Irrigation
        title: Pocket Irrigation
        href: /pocket-irrigation/
        wide: false
        links: []
      - _component: page-sections/ctas/services-grid/services-grid-item
        imageSource: ""
        imageAlt: Pocket Reduction Surgery
