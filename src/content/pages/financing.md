...
seo:
  ...
  description:
    Learn about financing options at North County Cosmetic and Implant Dentistry in Vista,
    CA. We offer flexible payment plans to help make dental care affordable.
pageSections:
  - _component: page-sections/builders/custom-section
    label: Pre Approved FinancingVista, CA
    contentSections:
      - _component: building-blocks/core-elements/heading
        text: Pre Approved FinancingVista, CA
        level: h1
        size: md
    maxContentWidth: xl
